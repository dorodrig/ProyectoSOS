...
/**
 * REST controller for managing {@link co.edu.sena.domain.Student}.
 */
@RestController
@RequestMapping("/api")
public class StudentResource {
    ...
    public ResponseEntity<List<StudentDTO>> getAllStudents(
        ...
        if ("ceetuser-is-null".equals(filter)) {
            log.debug("REST request to get all Students where ceetUser is null");
            return new ResponseEntity<>(studentService.findAllWhereCeetUserIsNull(), HttpStatus.OK);
        }
